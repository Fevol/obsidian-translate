...
<SettingItem
	...
	notices={[
		{ text: 'Setting applies to global commands (e.g. translating selections) and to newly opened translation views', type: 'info' },
		$fasttext_data.binary ? null : { text: `This option requires <b>FastText</b> to resolve the language of the input text`, type: 'warning' },
	]}
>
...
{#if $settings.apply_glossary}
	<SettingItem
		...
		notices={[
			{ text: glossary_selected_info[$settings.glossary_preference] , type: 'info' }
		]}
	>
		<Dropdown
			slot="control"
...
<SettingItem
	...
	notices={[
		{ text: target_language_preference[$settings.target_language_preference] , type: 'info' }
	]}
>
	<Dropdown
		slot="control"
