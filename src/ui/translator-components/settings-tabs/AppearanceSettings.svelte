...
<SettingItem
	...
	type="toggle"
	notices={[
		{ type: 'text', text: `Disabling this setting might introduce some visual bugs`, style: 'translator-warning-text'}
	]}
...
<SettingItem
	...
	notices={[
		{ type: 'text', text: `Useful for sharing a screenshot of your settings without showing the secret data`, style: 'translator-info-text' }
	]}
	type="toggle"
>
	<Toggle
