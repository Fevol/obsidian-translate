	...
	service_settings: {
		google_translate: {
			...
			available_languages: [
				...
				'hr', 'ht', 'hu', 'hy', 'id', 'ig', 'is', 'it', 'iw', 'ja', 'jw', 'ka', 'kk', 'km', 'kn', 'ko', 'ku',
