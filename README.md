...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|-------------------------------|---------|:-------|-----------|
| <img height="16px" align="center" src="images/service icons/google-translate.svg"> <a href="https://cloud.google.com/translate/docs/setup">Google Translate</a>                                                    | ✅         | *(0.5M characters/month)* ¹ ² |         |        | 136       |
...
| <img height="16px" align="center" src="images/service icons/azure-translator.svg"> <a href="https://azure.microsoft.com/en-us/free/">Azure Translator</a>                                                          | ✅         | *(2M characters/month)* ¹     |         |        | 135       |
